...
supported by the R caret package.  svmRadial is used as an example here. But the module can be used with any caret supported model by passing the corresponding parameter table provided by caret::getModelInfo. See the caret vignette to explore different models.
