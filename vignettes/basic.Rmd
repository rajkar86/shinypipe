...
```{r}
library(caret)
radioButtons("caretModel", "Select model", choices = c("svmRadial", "lm"))
```

```{r}
svm.params <- reactive(getModelInfo(input$caretModel)$svmRadial$parameters)

renderUI(ui.caretModel("model1", svm.params()))
