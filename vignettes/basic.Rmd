...
Plot module provides zoom/selection behavior and click location display over ggplots.
...
This module makes it easier to create an interface to create for any of regression or classification models
supported by the R caret package.  svmRadial is used as an example here. But the 
