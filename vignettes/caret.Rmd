...
renderUI(ui.caretModel("m1", reactive(names(getModelInfo())), selected = "svmRadial"))
r.caretModel <- callModule(s.caretModel, "m1")

r.model <- reactive(r.caretModel()$model)
...
renderTable(getInfoTableFromObj(r.model(), r.modelInfo()))
```
