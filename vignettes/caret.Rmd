...
### Notes
* Select the formula on the sidebar by choosing the explanatory variables (X). cyl and vs are factor variables that can be used in classification
...
### List to override train parameters (See help section for caret::train) {data-height="130px"}
```{r}
textAreaInput("trainList", NULL, width = '700px', height = "100px",
              value = "list()")
```

### List to override default train control (See help section for caret::trainControl) {data-height="130px"}
```{r}
